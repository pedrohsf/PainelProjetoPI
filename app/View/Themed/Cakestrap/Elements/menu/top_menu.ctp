...
<nav class="navbar navbar-default" role="navigation">
	<div class="collapse navbar-collapse navbar-ex1-collapse">
		<ul class="nav navbar-nav" style="width:80%; margin: 0 auto !important; float:none !important;">
            ...
            <li   <?= ($controller === 'professionalexperiences')? 'class="active"' : '' ?>><a href="<?= $admLocal ?>ProfessionalExperiences/">Experiências Profissional</a></li>
            ...
            <li style="float:right; " >
                <div class="btn-group" >
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="#" data-toggle="modal" data-target="#imageModalChange" >Trocar Imagem</a></li>
                        <li><a href="<?= $admLocal ?>Users/painelAluno"">Usuario</a></li>
                        <li><a href="<?= $admLocal ?>Files/index"">Trabalhos</a></li>
                        <li><a href="<?= $admLocal ?>ProfessionalExperiences/">Experiências Profissional</a></li>
                        <li class="divider"></li>
